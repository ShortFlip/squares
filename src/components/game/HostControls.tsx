  ...
  return (
    <>
      <button
        type="button"
        onClick={onNewRound}
        className="rounded-md px-3 py-1.5 text-[13px] font-semibold text-foreground/85 border border-white/12 hover:bg-white/8 hover:text-foreground transition-colors duration-150"
      >
        New Round
      </button>
      <button
        type="button"
        onClick={onEndGame}
        className="rounded-md px-3 py-1.5 text-[13px] font-semibold text-muted-foreground border border-white/12 hover:bg-white/8 hover:text-foreground transition-colors duration-150"
      >
        End Night
      </button>
    </>
